...
public class FoodController {
    ...
    public FoodResponse addFood(
            @Parameter(description = "Food item data as JSON string") @RequestPart("food") String foodString,
            @Parameter(description = "Image file for the food item") @RequestPart("file") MultipartFile file) {
    ...
    @GetMapping({"/{id}"})
    public ResponseEntity<FoodResponse> readFood(
            @Parameter(description = "ID of the food item to retrieve") @PathVariable("id") String id) {
    ...
    public void deleteFood(
            @Parameter(description = "ID of the food item to delete") @PathVariable("id") String id) {
