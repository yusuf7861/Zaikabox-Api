...
@Tag(name = "Contact", description = "APIs for handling contact us messages")
public class ContactUsController {
    ...
    public void setContactUsEmailService(
            @Parameter(description = "Contact request details") @RequestBody ContactUsRequest request) {
        try {
